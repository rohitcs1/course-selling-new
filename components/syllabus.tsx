    ...
    <section className="py-20 md:py-32 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          ...
          <a
            href={checkoutHref}
            className="group inline-flex items-center justify-center w-full md:w-1/2 mx-auto px-8 py-5 bg-gradient-to-b from-yellow-300 via-yellow-400 to-yellow-500 text-black font-extrabold rounded-xl hover:from-yellow-200 hover:via-yellow-300 hover:to-yellow-400 transition-all duration-300 text-lg shadow-lg hover:shadow-xl hover:-translate-y-1"
          >
