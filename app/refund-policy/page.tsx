  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-12">
        <div className="mx-auto max-w-6xl px-6 text-slate-700">
          <div className="mt-10 space-y-8 text-lg leading-8 sm:text-xl">
            ...
            <section>
              ...
              <p>
                We are confident in the value and quality of our "ELNEB EdTech Courses" online video editing course. If, for any reason, you are not satisfied with the course within the first 7 days from the date of purchase, you are eligible for a full refund of the course fee. No questions asked.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="mt-4 list-disc space-y-2 pl-6">
                ...
                <li>
                  - Your request for a refund must be submitted in writing to our customer support team at rasoiroom31@gmail.com with the subject line "Refund Request."
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                If you have any questions or need further assistance regarding our refund policy, please contact our customer support team at rasoiroom31@gmail.com or Whatsapp us at +91 7250939051.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                Thank you for choosing "ELNEB EdTech Courses" for your video editing education. We are dedicated to helping you achieve your creative goals, and we look forward to supporting your journey in the world of video editing.
              </p>
            </section>
          </div>
        </div>
      ...
      <footer className="mt-12 border-t border-slate-200 py-6 text-center">
        <div className="text-sm font-semibold text-slate-700 sm:text-base">
          <a href="/terms" className="hover:text-slate-950 transition-colors">Terms of Service</a>
