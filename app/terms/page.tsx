...
export default function TermsPage() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <p className="mb-4">Website Terms and Conditions of Use</p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-bold mb-2">7. Site Terms of Use Modifications</h2>
        <p>
      ...
      <p className="text-sm text-gray-600">Last updated: 18 May 2026</p>
    </main>
  )
}
